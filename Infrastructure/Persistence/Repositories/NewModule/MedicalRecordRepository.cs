...
{
    public class MedicalRecordRepository : NewModuleGenericRepository<MedicalRecord, Guid>, IMedicalRecordRepository
    {
        public MedicalRecordRepository(NewModuleContext context) : base(context)
        {
        }

        public async Task<IEnumerable<MedicalRecord>> GetRecordsByPetIdAsync(Guid petId)
        {
