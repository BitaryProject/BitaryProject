...
namespace Persistence.Repositories.NewModule
{
    public class DoctorScheduleRepository : IDoctorScheduleRepository
    {
        ...
        public async Task<DoctorSchedule> GetScheduleAsync(Guid doctorId, DayOfWeek day)
        {
            return await _dbSet
                .FirstOrDefaultAsync(s => s.DoctorId == doctorId && s.Day == day);
        }

        public async Task<IEnumerable<DoctorSchedule>> GetSchedulesByDoctorAsync(Guid doctorId)
        {
            return await _dbSet
        ...
        public async Task<bool> CheckScheduleConflictAsync(Guid doctorId, DayOfWeek day)
        {
            return await _dbSet
