...
namespace Presentation.Controllers
{
    ...
    public class AppointmentController : ApiController
    {
        ...
        [HttpGet("pet/{petId}")]
        public async Task<ActionResult<IEnumerable<AppointmentDTO>>> GetByPet(Guid petId)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<AppointmentDTO>> Update(Guid id, [FromBody] AppointmentDTO model)
        {
