...
namespace Presentation.Controllers
{
    ...
    public class DoctorController : ApiController
    {
        ...
        // PUT: api/Doctor/{id}
        [HttpPut("{id}")]
        public async Task<ActionResult<DoctorDTO>> Update(Guid id, [FromBody] DoctorDTO model)
        {
        ...
        public async Task<IActionResult> AddSchedule(Guid doctorId, [FromBody] DoctorScheduleDTO dto)
        {
